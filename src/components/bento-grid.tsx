		...
		<section>
			<div className="max-w-6xl mx-auto flex flex-col gap-6 w-[90%]">
				<div className="grid grid-cols-1 gap-6 lg:grid-cols-bentoLeft">
					<BentoGridCard
						Obj={{
							image: '/showcases/analytics.svg',
							heading: 'Complete web analytics system',
							description:
								'Keep track of all traffic going thorugh your website. Analyze visitors, sources, devices and other essential data points for better cusomer insights',
						}}
					/>
					<BentoGridCard
						Obj={{
							image: '/showcases/waitlists.svg',
				...
				<p className="mx-auto bg-main text-white rounded-xl px-4 py-2 font-bold text-sm mt-4 select-none">
