			...
			<div className="w-[90%] mx-auto text-center max-w-[1000px]">
				...
				<Reveal delayTime={0.3}>
					<p className="font-regular text-[18px] w-[80%] mx-auto text-gray-200 mb-[50px]">
						Wake up to an inbox full of new testimonial alerts.
						Share them everywhere in seconds. Get more visits,
						convert more, and close more deals. Senja makes it easy.
					</p>
				</Reveal>
				<Reveal delayTime={0.3}>
					<button
