...
export default function CookiePopup() {
    ...
    return (
        popupVisible &&         <div className="border bottom-6 flex flex-col gap-6 left-6 shadow-clean p-6 z-[100] bg-white fixed shadow-main/20 border-gray-600/10 rounded-2xl text-gray-600">
