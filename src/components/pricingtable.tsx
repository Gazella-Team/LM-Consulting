					...
					<div className="grid grid-cols-1 md:grid-cols-2 gap-10 rounded-2xl bg-white border border-gray-600/10 p-4 text-left">
						<div className="p-8 flex flex-col gap-8 opacity-60 border border-gray-600/10 rounded-xl">
							...
							<h1 className="text-5xl font-bold">
								<span className="line-through">$219</span>
							...
							<div className="border-t pt-6 border-t-gray-600/10">
								...
								<div className="flex text-center">
									<Link
										className="bg-slate-50 border border-gray-600/10 py-3 px-4 rounded-full static w-full text-gray-800 font-semibold text-sm"
										href={'/'}
									>
										Keep overpaying for an outdated setup
									</Link>
								</div>
							</div>
						</div>
						<div
							style={{
								background:
									'linear-gradient(180deg, rgba(255,255,255,1) 0%, rgba(94,23,235,0.03667804621848737) 100%)',
							}}
							...
							<div className="border-t pt-6 border-t-gray-600/10">
								...
								<div className="flex text-center">
									<button
										...
										className="bg-main py-3 px-4 border border-main rounded-full static w-full text-white font-semibold text-sm"
									>
										Join waitlist
									</button>
								</div>
