	...
	return (
		<section className="mb-24">
			<div className="flex items-center justify-center pb-14">
				<div className="rounded-full paragraph text-gray-600 shadow-sm p-1 relative gap- border bg-white border-gray-600/10 flex items-center justify-between">
					<div onClick={() => setPricingRuntime("monthly")} className={pricingRuntime === "monthly" ? "bg-main w-20 text-center text-white cursor-pointer rounded-full text-xs px-2 py-1 font-semibold":"bg-white w-20 text-center cursor-pointer rounded-full text-xs px-2 py-1 font-semibold"}>
						Monthly
					</div>
					<div onClick={() => setPricingRuntime("yearly")}  className={pricingRuntime === "yearly" ? "bg-main w-20 text-center text-white cursor-pointer rounded-full text-xs px-2 py-1 font-semibold":"bg-white w-20 text-center cursor-pointer rounded-full text-xs px-2 py-1 font-semibold"}>
						Yearly
					</div>
				</div>
			</div>
			...
			<div className="relative">
				<div className="bg-white relative h-full rounded-2xl border border-gray-600/10 text-gray-800 shadow-sm">
					...
					<div className="px-7 mb-14">
						<h1 className="text-5xl font-semibold">$0<span className="ml-1 paragraph text-base font-light text-gray-600">/ forever</span></h1>
					</div>
				...
				<div style={{background: "linear-gradient(350deg, rgba(243,237,255,1) 0%, rgba(255,255,255,1) 54%)"}} className="bg-white relative rounded-2xl border-2 border-main text-gray-800 shadow-main/30 shadow-clean">
					...
					<div className="px-7 pb-14 bg-white">
						<h1 className="text-5xl font-semibold">{pricingRuntime === "monthly" ? "$19":"$15"}<span className="ml-1 text-base paragraph font-light text-gray-600">/ {pricingRuntime === "monthly" ? "month":"month, billed yearly"}</span></h1>
					</div>
					<div className="bg-slate-50 border-y py-5 px-7 border-gray-600/10">
						<button
