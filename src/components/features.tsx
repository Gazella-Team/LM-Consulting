        ...
        <section className="py-[100px] bg-white">
            ...
            <div className="w-[95%] mx-auto max-w-[1300px]">
                <div className="bg-[url(/toolbgs/waitlists.svg)] bg-center bg-cover border border-gray-600/10 h-[500px] rounded-[30px] py-10 px-14">
                    ...
                    <p className="max-w-[400px] text-gray-600">Collecting signups for your waitlist can be challenging. Weve collected the top 10 best advice on how to build a packed list of signups for your coming waitlist</p>
                </div>
            </div>
        </section>
    )
