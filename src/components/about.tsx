...
export default function About() {
	return (
		<div className="py-24" style={{background: "radial-gradient(circle, rgba(103,27,255,0.06908700980392157) 0%, rgba(255,255,255,0) 67%)"}} >
			<div className="bg-white relative shadow-sm rounded-3xl border border-gray-600/10 p-16 text-gray-800 max-w-3xl mx-auto">
				<div>
					<Reveal delayTime={0}>
