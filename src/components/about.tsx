				...
				<div className="bg-white relative shadow-main/30 shadow-clean rounded-3xl border border-gray-600/10 p-16 text-gray-800 max-w-3xl mx-auto">
					<div>
						<div className="flex items-center mb-10">
							<img
								className="h-20 w-20 rounded-full border-2 border-main"
								src="/people/lasseosmann.webp"
							></img>
							<img
								className="h-20 w-20 rounded-full ml-[-20px] border-2 border-main"
								src="/people/simonmaribo.webp"
							></img>
						</div>
					...
					<p className="text-base text-gray-600 mb-14 paragraph mt-4 leading-[168%]">
						We&apos;re building Toolbird with a vision of making it
						easier for SaaS developers and tech startups to build,
						...
						easier Manage web analytics, cron jobs, monitoring,
						feature flags, waitlists, client feedback and more
						within just one platform. Toolbird makes building tech
						products easier
						<br></br>
						<br></br>
						Manage web analytics, cron jobs, monitoring, feature
					...
					<div className="flex items-center justify-end">
						<p className="font-[Caveat] text-2xl text-main">
							- Lasse and Simon<br></br>Founders of Toolbird
						</p>
					</div>
				</div>
			</div>
