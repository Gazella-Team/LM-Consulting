...
export default function SectionIntro(props:SectionIntroProps) {
    return (
        <div className="text-center text-gray-800 mb-14">
            ...
            <Reveal delayTime={0.1}>
                <h2 className="text-4xl md:text-5xl w-[90%] mx-auto font-black mb-4">{props.heading}</h2>
            </Reveal>
            <Reveal delayTime={0.2}>
                <p className="text-lg max-w-3xl w-[90%] mx-auto text-gray-600">{props.description}</p>
            </Reveal>
