        ...
        <section style={{background: "radial-gradient(circle, rgba(30,50,30,1) 0%, rgba(1,25,0,1) 100%)"}} className="min-h-screen z-10">
            <div className="pt-40 w-[90%] flex flex-col gap-12 mx-auto max-w-4xl text-center text-white">
                <div className="flex flex-col gap-6 z-10 relative">
                    ...
                    <Reveal delayTime={0.1}>
                        <h2 className="text-4xl md:text-5xl xl:text-7xl font-semibold">Introducing AI-powered <span className="gradient-text">ecommerce reporting</span></h2>
                    </Reveal>
                ...
                <div>
                    <RevealLight delayTime={0.4}>
                        <Link className="rounded-full z-10 text-green-950 font-semibold px-5 py-2 bg-gradient-to-r from-[#c3f1d3] to-[#d3ffd3]" href={"/"}>Sign up for waitlist</Link>
                    </RevealLight>
                </div>
            </div>
