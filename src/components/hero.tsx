...
export default function Hero() {
	return (
		<section className="py-[100px] pb-[0px] relative">
			...
			<div className="w-[86%] mx-auto max-w-6xl flex flex-col gap-5 ">
				...
				<Reveal delayTime={0.1}>
					<h1 className="text-4xl md:text-5xl xl:text-6xl max-w-[700px] leading-[110%] font-black text-gray-800 heading">
						The ultimate toolbox for SaaS developers
					</h1>
				</Reveal>
				<Reveal delayTime={0.2}>
					<p className="text-base md:text-lg xl:text-lg font-regular paragraph max-w-[500px] w-[85%] text-gray-600">
				...
				<RevealLight delayTime={0.4}>
					<div className="flex items-center gap-3 mt-4 font-medium">
						<button
