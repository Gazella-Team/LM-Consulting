...
export default function Waitlists() {
	return (
		<Layout white={true}>
			...
			<SectionIntro
				bottomMargin={true}
				heading="One system to to collect and manage signups"
				description="Our prebuilt waitlist system allows you to start collecting signups in less than a minute through a simple embed code."
