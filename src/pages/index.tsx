    ...
    <section className="bg-[url(/bg.svg)] bg-center bg-cover h-screen flex items-center justify-center">
      <div className="bg-white rounded-xl border border-gray-600/10 p-14 w-[94%] mx-auto max-w-[1000px] min-h-[580px] shadow-xl flex flex-col justify-between">
        <div>
          ...
          <h1 className="text-2xl leading-[30px] md:text-4xl md:leading-[44px] max-w-[600px] headingText text-gray-800 mb-4">Introducing ToolBird: The ultimate toolbox for <span className="headingText text-main">SaaS developers.</span></h1>
          ...
          <div className="hidden md:flex gap-10 font-medium text-[15px]">
        ...
        <div className="flex gap-2 mt-16">
          <input placeholder="example@toolbird.io" type="e-mail" className="bg-slate-50 text-sm pl-2 text-gray-800 border border-gray-600/10 rounded-md flex-1 placeholder:text-sm" value={email} onChange={(value) => setEmail(value.currentTarget.value)}></input>
          <button className="bg-main text-white px-4 py-2 text-sm font-medium rounded-md" onClick={() => handleSubmit()}>
            Join waitlist
          </button>
        </div>
        <p className="text-center text-sm mt-4 text-gray-400">Free usage for the first month. Limited spots.<br></br><span>Powered by Gazella Team</span></p>
      </div>
      </div>
    </section>
  );
