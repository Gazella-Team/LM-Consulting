  ...
  return (
    <section className="bg-[url(/bg.svg)] bg-center bg-cover h-screen flex items-center justify-center">
      <div className="bg-white rounded-xl border border-gray-600/10 p-14 w-[94%] mx-auto max-w-[1000px] min-h-[580px] shadow-xl flex flex-col justify-between">
        <div>
          <img className="w-[120px] mb-2" src="/logos/logograytext.svg" />
          ...
          <p className="text-gray-600 text-sm md:text-base max-w-[700px] mb-8">
            ...
            where SaaS developers can manage tools.
          </p>
          ...
          <div className="flex gap-2 mt-16">
            ...
            ></input>
            <button
              className="bg-main text-white px-4 py-2 text-sm font-medium rounded-md"
          ...
          <p className="text-center text-sm mt-4 text-gray-400">
            Free usage for the first month. Limited spots.<br></br>
            <span>Powered by Gazella Team</span>
          </p>
        </div>
      </div>
    </section>
