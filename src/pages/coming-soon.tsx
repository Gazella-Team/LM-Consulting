...
export default function ComingSoon() {
	return (
		<Layout noCta={true} white={true}>
            <div style={{background: "linear-gradient(329deg, rgba(244,244,244,1) 0%, rgba(250,248,255,1) 17%, rgba(247,247,247,1) 37%, rgba(253,252,255,1) 67%, rgba(252,251,255,1) 94%)"}} className='w-full md:w-[86%] md:rounded-[100px] backdrop:blur-3xl md:border-y md:mb-6 border-gray-600/10 mx-auto max-w-7xl flex items-center min-h-[60vh] text-center justify-center'>
                <div className='flex flex-col gap-4'>
                    <h2 className='text-gray-800 font-semibold text-5xl'>Coming Soon</h2>
