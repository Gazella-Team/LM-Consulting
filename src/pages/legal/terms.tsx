	...
	return (
		<Layout white={true}>
			<div className='w-[86%] mx-auto max-w-6xl py-32 text-center'>
				<h1 className='text-gray-800 text-6xl font-semibold'>Terms of Service</h1>
			</div>
