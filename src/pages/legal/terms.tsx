...
export default function Terms() {
	return (
		<Layout white={true}>
			<Meta
				title={`Terms of service - Toolbird.io`}
			/>
...
If you are entering into this Agreement on behalf of a company, business or other legal entity, you represent that you have the authority to bind such entity to this Agreement, in which case the term &quot;you&quot; shall refer to such entity. If you do not have such authority, or if you do not agree with this Agreement, you must not accept this Agreement and may not use the Services.						</p>
						...
						<div className='flex flex-col gap-5'>
							<h2 className='text-xl font-semibold text-gray-800'>4. Changes to these Terms</h2>
						...
						<div className='flex flex-col gap-5'>
							...
							<p>Questions or comments about the Website or these Terms of Service may be directed to our support team at contact@toolbird.io</p>
						</div>
						<div className='flex flex-col gap-5'>
						...
						<div className='flex flex-col gap-5'>
							<h2 className='text-xl font-semibold text-gray-800'>8. Governing Law and Jurisdiction</h2>
							<p>These Terms of Service and any dispute or claim arising out of or related to them, their subject matter or their formation (in each case, including non-contractual disputes or claims) shall be governed by and construed in accordance with the internal laws of the State of California without giving effect to any choice or conflict of law provision or rule. Any legal suit, action, or proceeding arising out of, or related to, these Terms of Service or the Website shall be instituted exclusively in the federal courts of Denmark.</p>
						</div>
						<div className='flex flex-col gap-5'>
							<h2 className='text-xl font-semibold text-gray-800'>Thanks for using Toolbird</h2>
							<p>By using Toolbird, you acknowledge that you have read these Terms of Service, understood them, and agree to be bound by them. If you do not agree to these Terms of Service, you are not authorized to use the Service. We reserve the right to change these Terms of Service at any time, so please review them frequently.</p>
						</div>
